...
@implementation MHTransformCorrdinate
...
+(CLLocationCoordinate2D)transformFromWGSToGCJ:(CLLocationCoordinate2D)wgsLoc
{
    ...
    if([self isLocationOutOfChina:wgsLoc]){
        ...
        double adjustLat = [[self alloc] transformLatWithX:wgsLoc.longitude - 105.0 withY:wgsLoc.latitude - 35.0];
        double adjustLon = [[self alloc] transformLonWithX:wgsLoc.longitude - 105.0 withY:wgsLoc.latitude - 35.0];
