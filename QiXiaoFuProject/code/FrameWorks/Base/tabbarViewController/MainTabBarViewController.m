...
// 环信
static NSString * const kItem1ImageName = @"pub_icon_home_n";
static NSString * const kItem1SelectedImageName = @"pub_icon_home_s";

static NSString * const kItem2imageName = @"pub_icon_shop_n";
static NSString * const kItem2SelectedImageName = @"pub_icon_shop_s";
...
@interface MainTabBarViewController () <UITabBarControllerDelegate,UIAlertViewDelegate,EMClientDelegate>{
...
//     [[[ChatDemoHelper alloc]init] initcontrollers];
    [self easeMod];
}
...
- (void)addAllChildVcs
{
    ...
    [self addOneChlildVc:orderViewController title:kTabbarTitle1 imageName:kItem1ImageName selectedImageName:kItem1SelectedImageName];
...
- (void)addOneChlildVc:(UIViewController *)childVc title:(NSString *)title imageName:(NSString *)imageName selectedImageName:(NSString *)selectedImageName
{
    ...
    // 设置tabBarItem的普通文字颜色
    [childVc.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor blackColor],NSFontAttributeName:[UIFont systemFontOfSize:10]} forState:UIControlStateNormal];

    // 设置tabBarItem的选中文字颜色
    [childVc.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:kThemeColor,NSFontAttributeName:[UIFont systemFontOfSize:10]} forState:UIControlStateSelected];
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController{
    ...
    [MCNetTool postWithCachePageUrl:HttpMainMemberOs params:params success:^(NSDictionary *requestDic, NSString *msg, BOOL hasmore, NSInteger page_total) {
...
-(void)setupUnreadMessageCount
{
    ...
    if (_chatListVC) {
        if (unreadCount > 0) {
            _chatListVC.tabBarItem.badgeValue = [NSString stringWithFormat:@"%ld",unreadCount+kUnreadSystemMessageNumber];
        }else{
            if (kUnreadSystemMessageNumber >0) {
                _chatListVC.tabBarItem.badgeValue =  [NSString stringWithFormat:@"%ld",kUnreadSystemMessageNumber];
