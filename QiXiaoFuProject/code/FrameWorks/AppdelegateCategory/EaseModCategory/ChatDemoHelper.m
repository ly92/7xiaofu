...
//    [alertView show];
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"repeatLogon"object:nil];

    
    
    [[NSNotificationCenter defaultCenter] postNotificationName:KNOTIFICATION_LOGINCHANGE object:@NO];
    
    BlockUIAlertView * alert = [[BlockUIAlertView alloc]initWithTitle:@"提示" message:@"此账号已在其他设备登陆，如非本人操作，请修改密码" cancelButtonTitle:nil clickButton:^(NSInteger buttonIndex) {
...
- (void)didReceiveMessages:(NSArray *)aMessages
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"didReceiveMessages" object:aMessages];
