...
@implementation WB_Stopwatch

- (instancetype) init {
    if (self = [super init]) {
        _timeLabel = self;
        _stopwatchLabelType = WBTypeStopWatch;
    }
    return self;
}
...
- (instancetype) initWithLabel:(UILabel *)anLabel andTimerType:(WB_StopwatchLabelType)anType {
...
- (void) updateLabel:(NSTimer *) timer {
    ...
    if (_stopwatchLabelType == WBTypeStopWatch) {
        if (_counting) {
...
- (void) reset {
    ...
    if(_stopwatchLabelType == WBTypeStopWatch) timeUserValue = 0;
