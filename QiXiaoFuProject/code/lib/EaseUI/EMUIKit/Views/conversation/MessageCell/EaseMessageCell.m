                         ...
                         model:(id<IMessageModel>)model
{
    ...
    _avatarView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"default_user_portrait.gif"]];
...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    LxDBAnyVar(_model.message.from);//  自己 
    LxDBAnyVar(_model.message.to);//  客服 

//    if(_model.message.direction == EMMessageDirectionSend){
//    
//        _model.avatarURLPath = @"http://139.129.213.138/data/upload/shop/common/default_user_portrait.gif";
//    }else{
//        _model.avatarURLPath = @"http://139.129.213.138/UPLOAD/sys/2016-11-08/~UPLOAD~sys~2016-11-08@AD7DFCBE-2509-43BB-B8ED-54D16D4E9146.png";
//    }
