...
{
    if ([self.delegate respondsToSelector:@selector(conversationListViewReFreshHeaderView)]) {
        
        [self.delegate conversationListViewReFreshHeaderView];
    }
    
    NSArray *conversations = [[EMClient sharedClient].chatManager getAllConversations];
    NSArray* sorted = [conversations sortedArrayUsingComparator:
                       ^NSComparisonResult(EMConversation *obj1, EMConversation* obj2){
