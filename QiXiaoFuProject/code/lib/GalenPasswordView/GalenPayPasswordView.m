...
- (void)removeAllNumbers{
    ...
    [self.inPutView removeAllNUmers];
...
-(void)lessPwdBtnView
{
    ...
    [noPWD setTitleColor:[UIColor darkGrayColor] forState:UIControlStateNormal];
    [noPWD setTitleColor:kThemeColor forState:UIControlStateHighlighted];
...
-(void)intputFinish
{
    if (self.inputPassFinish) {
        
        self.inputPassFinish(tempStr);
        tempStr = nil;
