...
@optional
-(void)toobarDonBtnHaveClick:(ZHPickView *)pickView resultString:(NSString *)resultString withRow:(NSInteger)row;
...
@property (nonatomic,copy) void (^completionPickView)(NSString *resultString,NSInteger row,NSInteger tag);
