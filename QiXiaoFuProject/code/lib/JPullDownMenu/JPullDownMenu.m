...
-(void)configBaseInfo
{
    ...
    DownMenuTopView *  downMenuTopView =[DownMenuTopView downMenuTopView];
    downMenuTopView.frame =CGRectMake(0, 0, Kscreen_width, KTitleButtonHeight);
    [self addSubview:downMenuTopView];

    
    
    [downMenuTopView.leftBtn setTitle:self.titleArray[0] forState:UIControlStateNormal];
    [downMenuTopView.leftBtn setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
    downMenuTopView.leftBtn.tag =KTitleButtonTag + 0 ;
    [downMenuTopView.leftBtn addTarget:self action:@selector(titleButtonClick:) forControlEvents:UIControlEventTouchUpInside];
    downMenuTopView.leftBtn.titleLabel.font = [UIFont systemFontOfSize:15];
    [downMenuTopView.leftBtn setTitleColor:kThemeColor forState:UIControlStateSelected];
    [downMenuTopView.leftBtn setImage:[UIImage imageNamed:@"JPullDown.bundle/jiantou_up"] forState:UIControlStateNormal];
    [downMenuTopView.leftBtn setImage:[UIImage imageNamed:@"JPullDown.bundle/jiantou_down"] forState:UIControlStateSelected];
    downMenuTopView.leftBtn.imageEdgeInsets = UIEdgeInsetsMake(0, -10, 0, 0);
    
    
    
    [downMenuTopView.rightBtn setTitle:self.titleArray[1] forState:UIControlStateNormal];
    [downMenuTopView.rightBtn setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
    downMenuTopView.rightBtn.tag =KTitleButtonTag + 1 ;
    [downMenuTopView.rightBtn addTarget:self action:@selector(titleButtonClick:) forControlEvents:UIControlEventTouchUpInside];
    downMenuTopView.rightBtn.titleLabel.font = [UIFont systemFontOfSize:15];
    [downMenuTopView.rightBtn setTitleColor:kThemeColor forState:UIControlStateSelected];
    [downMenuTopView.rightBtn setImage:[UIImage imageNamed:@"JPullDown.bundle/jiantou_up"] forState:UIControlStateNormal];
    [downMenuTopView.rightBtn setImage:[UIImage imageNamed:@"JPullDown.bundle/jiantou_down"] forState:UIControlStateSelected];
    downMenuTopView.rightBtn.imageEdgeInsets = UIEdgeInsetsMake(0, -10, 0, 0);
    
    [self.buttonArray addObject:downMenuTopView.leftBtn];
    [self.buttonArray addObject:downMenuTopView.rightBtn];

    
//    //用于遮盖self.backgroundColor 。
//    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, Kscreen_width, self.selfOriginalHeight)];
...
//        [titleButton setTitleColor:kMainColor forState:UIControlStateSelected];
