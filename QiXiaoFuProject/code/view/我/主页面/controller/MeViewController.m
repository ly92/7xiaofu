...
//        SCNavTabBarController * vc = [[SCNavTabBarController alloc]initWithTitleArr:@[@"已接单",@"已完成",@"已取消",@"补单"]  andClass:[MyReceivingOrderViewController class]];
//        vc.navigationItem.title = @"我的接单";
//        //设置数据的key
//        [vc setRequestDataKeyArr:@[@2,@3,@5,@7]];
