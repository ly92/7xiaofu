...
@interface ACPwdInputView ()
@property (strong, nonatomic) NSMutableArray *secureDots; ///< secure dot
@property (strong, nonatomic) UITextField *responder;     ///< keyboard responder
@end

@implementation ACPwdInputView
