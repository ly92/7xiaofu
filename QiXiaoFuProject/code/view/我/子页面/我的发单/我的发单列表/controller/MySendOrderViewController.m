...
- (void)myBillListDataPage:(NSInteger )page hud:(BOOL )hud{
    ...
    if (self.sendOrderStatus == SendOrderStatusEnroll){
        NSMutableDictionary * params = [NSMutableDictionary new];
        params[@"userid"] = kUserId;
        hud?[self showLoading]:@"";
        [MCNetTool postWithUrl:HttpMainMySendEnrollBillList params:params success:^(NSDictionary *requestDic, NSString *msg) {
