...
@interface ShopOrderStateCell : UITableViewCell
...
@property(nonatomic, copy) void (^shopOrderCellTuiHuanHuostpe2Block)(NSString * order_id,NSIndexPath * cellIndexPath);
@property(nonatomic, copy) void (^shopOrderCellTuiHuanHuostpe3Block)(NSString * order_id,NSIndexPath * cellIndexPath);
