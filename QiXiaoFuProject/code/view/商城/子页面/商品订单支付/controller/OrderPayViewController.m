...
//                }
            ...
            cell.priceTextFieldBlock =^(NSString * text){
                ...
                if ([text floatValue] > _wallet) {
                    ...
                    _netPaypPrice = _order_price - _wallet_price;
...
- (void)submintRequestWithPayPass:(NSString *)payPass{
    ...
    _requestParams[@"store_id"] = @"1";
    _requestParams[@"pay_sn"] = _pay_sn;
    if (_useWallet) {
    ...
    [MCNetTool postWithUrl:HttpShopCheckstand_save params:_requestParams success:^(NSDictionary *requestDic, NSString *msg) {
