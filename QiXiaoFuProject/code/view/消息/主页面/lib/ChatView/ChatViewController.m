...
//    model.avatarImage = kDefaultImage_header ;//[UIImage imageNamed:@"EaseUIResource.bundle/user"];
...
//    model.avatarURLPath =_friendIcon;
//    model.failImageName =@"imageDownloadFail";
    
    if (model.isSender == YES) {
//        model.avatarURLPath = _userIcon;
        model.avatarImage = _userIconImage;
    }else{
//        model.avatarURLPath = _friendIcon;
        model.avatarImage = _friendIconImage;
    }
    return model;
}
